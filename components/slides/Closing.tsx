...
const Closing: React.FC = () => {
  return (
    <div className="h-full w-full bg-[#1A1512] text-[#FFFBF0] flex flex-col justify-center px-6 md:px-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col justify-center">
            ...
            >
                <ArtyrealLogo className="h-12 w-auto" />
            </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-colors group cursor-pointer"
          >
            <h3 className="text-2xl font-bold mb-6 flex items-center gap-3 group-hover:text-[#E94057] transition-colors">
            ...
            >
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-5 group cursor-pointer">
                        <div className="p-4 bg-white/5 rounded-full group-hover:bg-[#E94057] group-hover:text-white transition-all duration-300 border border-white/5">
                            <Globe className="w-6 h-6" />
                        </div>
                        <div>
                            <div className="text-xs text-white/40 uppercase tracking-widest mb-1">Official Website</div>
                            <div className="text-2xl font-medium">Artyreal.com</div>
                        </div>
                    </div>
